...
def parse_args() -> QueryConfig:
    ...
    # Maine yahan se required=True hata diya hai
...
# -------------------- RETRIEVER & LLM --------------------
# (Class Retriever aur build_llm functions same rahenge jo upar diye the)
...
def build_llm(model_name: str, temperature: float) -> ChatOllama:
